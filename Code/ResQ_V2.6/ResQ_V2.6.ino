...
Changed Baud rate of HC-05 Module as per this instruction https://shyyko.com/2015/07/13/changing_of_baud_rate_hc_05/
You need to program it one time with Serial adapter via AT commands:
"AT+UART=115200,1,0"
"AT+NAME=ResQ"
Works with android tabled at 115200 YAY!  Now we can monitor Resq from cockpit of light aircraft etc with air unit mounted outside the fuselage. 
...
//Splash Screen
  ...
  u8x8.println("");
  u8x8.println("ResQ Tool V2.6"); // YAY 2.2 fixed crashing/sd card shenanegins
